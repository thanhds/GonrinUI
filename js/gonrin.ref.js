(function(factory) {
    ...
    var GonrinRef = function(element, options) {
        ...
        if (element.is('input')) {
            ...
            var componentButton = $('<button type="button" style="padding:0px 15px" class="btn btn-outline-secondary dropdown-toggle dropdown-toggle-split" data-dropdown="dropdown">').html('<span class="fa fa-caret-down"></span>');
